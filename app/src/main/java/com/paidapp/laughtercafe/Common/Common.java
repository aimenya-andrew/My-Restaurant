package com.paidapp.laughtercafe.Common;
...
import com.paidapp.laughtercafe.Model.TokenModel;
import com.paidapp.laughtercafe.Model.UserModel;
import com.paidapp.laughtercafe.R;
import com.google.firebase.database.FirebaseDatabase;
import com.paidapp.laughtercafe.services.MyFCMServices;
...
public class Common {
    ...
    public static void showNotification(Context context, int id, String title, String content, Intent intent) {
        ...
        String NOTIFICATION_CHANNEL_ID = "Laughtercafe";
        NotificationManager notificationManager = (NotificationManager)context.getSystemService(Context.NOTIFICATION_SERVICE);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID,
                    "Laughtercafe",NotificationManager.IMPORTANCE_DEFAULT);
            notificationChannel.setDescription("Laughtercafe");
    ...
    public static String generateChatRoomId(String a, String b) {
        if (a.compareTo(b) > 0)
            ...
            return new StringBuilder("ChatYourSelf_Error")
