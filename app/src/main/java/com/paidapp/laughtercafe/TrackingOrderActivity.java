...
import com.paidapp.laughtercafe.Common.MyCustomMarkerAdapter;
import com.paidapp.laughtercafe.Model.ShippingOrderModel;
import com.paidapp.laughtercafe.Remote.IGoogleAPI;
import com.paidapp.laughtercafe.Remote.RetrofitGoogleAPIClient;
...
public class TrackingOrderActivity extends FragmentActivity implements OnMapReadyCallback, ValueEventListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            if (!success)
                Log.e("Laughtercafe","Style parsing failed");
        }catch (Resources.NotFoundException ex)
        {
            Log.e("Laughtercafe","Resource not found");
        }
